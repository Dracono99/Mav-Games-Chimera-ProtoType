...
GfxStats::GfxStats()
	: mFont(0), mFPS(0.0f), mMilliSecPerFrame(0.0f), mNumTris(0), mNumVertices(0), mNumObjects(0)
{
...
void GfxStats::display()
{
	...
	sprintf_s(buffer, "Frames Per Second = %.2f\n"
		...
		"Vertex Count = %d\n"
		"Object Count = %d", mFPS, mMilliSecPerFrame, mNumTris, mNumVertices, mNumObjects);

	RECT R = {5, 5, 0, 0};
	HR(mFont->DrawText(0, buffer, -1, &R, DT_NOCLIP, D3DCOLOR_XRGB(125,125,125)));
}