...
struct VertexPTN
{
	VertexPTN()
		...
		tex0(0.0f, 0.0f),
		normal(0.0f, 0.0f, 0.0f){}
	VertexPTN(float x, float y, float z,
		float u, float v,
		float nx, float ny, float nz):pos(x,y,z),tex0(u,v) ,normal(nx,ny,nz) {}
	VertexPTN(const D3DXVECTOR3& v, const D3DXVECTOR2& uv, const D3DXVECTOR3& n)
		:pos(v), tex0(uv),normal(n){}
...
struct VertexPCI
{
	VertexPCI():pos(0.0f, 0.0f, 0.0f){}
	VertexPCI(float x, float y, float z):pos(x,y,z){}
	VertexPCI(const D3DXVECTOR3& v):pos(v){}
