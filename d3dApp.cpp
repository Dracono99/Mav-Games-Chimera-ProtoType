...
D3DApp::D3DApp(HINSTANCE hInstance, std::string winCaption, D3DDEVTYPE devType, DWORD requestedVP,HWND windowHandle)
{
...
int D3DApp::activate( WPARAM wParam)
{
...
int D3DApp::Size(WPARAM wParam, LPARAM lParam)
{
	...
	if( gd3dDevice )
	{
		...
		else if( wParam == SIZE_MAXIMIZED )
		{
			mAppPaused = false;
			minOrMaxed = true;
			gd3dApp->onLostDevice();
			HR(gd3dDevice->Reset(&md3dPP));
			gd3dApp->onResetDevice();
		}
...
int D3DApp::msgProc(UINT msg, WPARAM wParam, LPARAM lParam)
{
	return 0;
